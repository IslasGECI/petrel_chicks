...
### Removed
- Warnings for `calculate_mass_diff_2()`. Now we specify the format to parse from string to datetime.
## [0.7.1] - 2025-09-19
### Changed
- The legend on the figures generated by the command `plot-all-peak-mass-models` now show the age and peak mass values.
